...
def test_list_domain_certificates(bucket_name, domain):
    ...
    path = f"/?domainCertificate&domain={domain}"
...
if __name__ == "__main__":
    ...
    print(f"Testing list domain certificates API with bucket name: {bucket_name} and domain: {domain}")
    
    print("\n--- 列举下行域名证书 ---")
    response = test_list_domain_certificates(bucket_name, domain)
    print(f"列举下行域名证书响应内容: {response}")
