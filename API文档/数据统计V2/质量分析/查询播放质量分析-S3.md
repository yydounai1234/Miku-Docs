...
## 请求路径
```
GET /?statistic=quality&direction=play&version=s3
```
...
## 请求示例
```http
GET /?statistic=quality&direction=play&version=s3&startTime=2023-01-01T00:00:00Z&endTime=2023-01-01T23:59:59Z&bucket=test-bucket HTTP/1.1
